        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              The most exciting lottery platform on Solana. Join thousands of players and win big with our daily draws and instant payouts.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/lottery" className="text-gray-400 hover:text-white transition-colors">
                  Lottery
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Solana Lottery. All rights reserved.
            </p>
